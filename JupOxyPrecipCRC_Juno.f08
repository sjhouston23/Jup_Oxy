...
parameter(number_of_energies=10,atmosLen=1544,nE2strBins=260,nProc=36,nChS=10)
...
totalCD  =0.0;oxEngBins=0.0;stopPowerEBins=0.0;es=0.0;E2str=0.0
altitude =0.0;sigTot   =0.0;prode2stF     =0.0;count=0
altDelta =0.0;elect    =0  ;prode2stB     =0.0;pHp=0
energy   =0  ;nSPions  =0  ;OxygenCX      =0.0;pH2p=0
...
H2Ex  =0;oxygen    =0;electFwdAE=0;electBwdAE=0;dEvsEng    =0.0;SIM    =0
NSIM  =0;collisions=0;totalHp   =0;totalH2p  =0
...
write(205,*) trial
close(205)
write(filename,'("./Output/Juno/PJ7_1/Overview",I0,".dat")') trial
...
do i=1,nOutputFiles
  write(filename,'("./Output/Juno/PJ7_1/",A,I0,".dat")') &
        trim(filenames(i)),trial
