...
!     do k=12,12!2,13
!       do l=1,ne
!         ! if(i.eq.6.and.eProbFunc(i,j,k,l).lt.1.0e-4)then
!         !   eProbFunc(i,j,k,l)=0.0d0
!         ! elseif(eProbFunc(i,j,k,l).lt.1.0e-7)then
!         !   eProbFunc(i,j,k,l)=0.0d0
!         ! end if
!         write(*,*) l,eProbFunc(i,j,1,l),eProbFunc(i,j,k,l)
!       end do
!     end do
!   end do
! end do
...
!************************** Energy Loss Calculations ***************************
      ...
      ! if(dEold.ge.500)write(*,10001) E,dEsp,dE,dN,dEold,process,PID(1),PID(2),tempQold
      ! if(dEold.ge.20000)write(*,*) eAngleDS,eEnergyDS
...
! if(open)then
!   write(*,*) 'Elapsed_Times.dat open... Sleeping for [secs]: ', trial/10000
!   flush(*)
